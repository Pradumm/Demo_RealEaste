...
const Testimonial = () => {
    return (
        <>
            <div className='bg-black text-white lg:px-20 px-4 py-8 mb-4'>
                ...
                <div id="default-carousel" className="relative mx-auto container  " data-carousel="slide">
                    {/* Carousel wrapper */}
                    <div className="relative max-w-4xl mx-auto flex justify-center items-center  overflow-hidden rounded-lg lg:h-96">
                        {/* Item 1 */}
                            ...
                            <div className='grid grid-col-1 lg:grid-cols-[auto_60%] gap-10'>
                                ...
                                <div>
                                    ...
                                    <div className='py-6'>
                                     ...
                                     <button className=' hover:text-white text-[#C5B351] uppercase border border-[#C5B351]  px-12 py-3.5'>more testimonial</button>
                                </div>
                            </div>
                        </div>
