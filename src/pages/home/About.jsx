            ...
            <div className='w-full bg-center  bg-no-repeat bg-cover' style={{ backgroundImage: `url("././asset/background_white.webp")` }} >
                ...
                <div className="container px-4 lg:px-10 mx-auto ">
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-full lg:w-[40%] h-60 lg:h-auto bg-center rounded-xl  bg-no-repeat bg-cover' style={{ backgroundImage: `url("././asset/agent.webp")` }} >
                           
                        </div>

                        <div className='w-full lg:w-3/5 py-5 md:pl-10 '>
                            <p className='text-xl italic mb-4'>About</p>
                            <h1 className='text-3xl lg:text-5xl font-[400] text-[#C5B351] capitalize  mb-5'>Rav Sandhu, Your Local Realtor</h1>
